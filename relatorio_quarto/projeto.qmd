...
| Documento  | Texto                           | TF (palavra "dados") | IDF ("dados") | TF-IDF ("dados") |
|------------|---------------------------------|----------------------|--------------|------------------|
| **D1**     | "Análise de dados é essencial" | 1/4 = 0.25           | log(3/2)     | 0.25 × log(3/2)  |
| **D2**     | "Os dados precisam ser limpos" | 1/5 = 0.20           | log(3/2)     | 0.20 × log(3/2)  |
| **D3**     | "Limpeza de dados e análise"   | 1/5 = 0.20           | log(3/2)     | 0.20 × log(3/2)  |
...
#| tbl-cap: Amostra de 5 linhas e 5 colunas da tabela de cursos
#| tbl-pos: H
#| tbl-width: 3
...
#| tbl-cap: Amostra de 5 linhas da tabela de livros
#| tbl-pos: H
#| tbl-width: 3
#Importando os dados das capacitacoes
...
df_books_text.head(5)
```



## Medida de Similaridade: A similaridade do Cosseno e pq utiliza-la.(EM METODOLOGIA)
