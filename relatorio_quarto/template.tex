...
% definir fontes segundo padroes enap
...
\backgroundsetup{
  ...
  vshift=0pt,
  hshift=0pt,
  contents={\includegraphics[width=1.0\paperwidth, height=1.0\paperheight]{modelostex/CAPA_PROVISORIA.pdf}}
}
...
\setlength{\cftbeforesecskip}{20pt} % Espaçamento antes das seções
\setlength{\cftbeforesubsecskip}{5pt} % Espaçamento antes das subseções
\setlength{\cftbeforesubsubsecskip}{5pt} % Espaçamento antes das subsubseções
